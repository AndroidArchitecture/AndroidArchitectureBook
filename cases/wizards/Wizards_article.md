...
В нашей Чистой архитектуре такой сущности, к сожалению, нет.<br>
Презентер? Но Презентер в нашем представлении отвечает за конкретную вьюшку, а не за несколько. Плюс Презентеру необходимо будет еще динамически как-то подключать новые вьюшки. В общем, это не его работа.<br>
...
С точки зрения Даггера мы имеем два модуля (`WizardModule` и `WizardNavigationModule`), соединенных вместе в `WizardComponent`. В общем-то и все особенности.<br>
